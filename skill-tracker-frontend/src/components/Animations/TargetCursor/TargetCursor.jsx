/*
  ...
  Modified to auto-disable on mobile & touch devices
*/
...
const TargetCursor = ({
  ...
  useEffect(() => {
    // 🚀 Skip logic on mobile/touch devices
  ...
  useEffect(() => {
    if (!cursorRef.current || !spinTl.current || isMobileOrTouch) return;
